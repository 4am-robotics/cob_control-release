## cob_control (noetic) - 0.8.24-2

The packages in the `cob_control` repository were released into the `noetic` distro by running `/usr/local/bin/bloom-release --rosdistro noetic --edit cob_control` on `Tue, 30 Apr 2024 11:41:23 -0000`
...
- rosdistro version: `0.8.23-1`
- old version: `0.8.24-1`
- new version: `0.8.24-2`
...
## cob_control (noetic) - 0.8.24-1

The packages in the `cob_control` repository were released into the `noetic` distro by running `/usr/local/bin/bloom-release --ros-distro noetic --edit cob_control` on `Thu, 18 Apr 2024 10:41:23 -0000`
...
- release repository: https://github.com/4am-robotics/cob_control-release.git
- rosdistro version: `0.8.23-1`
- old version: `0.8.23-1`
- new version: `0.8.24-1`
...
- release repository: https://github.com/ipa320/cob_control-release.git
- rosdistro version: `0.8.21-1`
- old version: `0.8.21-1`
- new version: `0.8.22-1`
...
The packages in the `cob_control` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release cob_control --track kinetic --rosdistro kinetic` on `Sat, 21 Jul 2018 16:23:26 -0000`
