...
Name:           ros-noetic-cob-model-identifier
Version:        0.8.13
...
%description
The cob_model_identifier package provides nodes to analyse the system response
behavior of actuators to optimally tune PID controllers to be used with
cob_twist_controller framework.
