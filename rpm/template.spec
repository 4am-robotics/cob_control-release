...
Name:           ros-noetic-cob-frame-tracker
Version:        0.8.13
...
%description
The cob_frame_tracker package contains nodes that publish Twist commands based
on the distance to the desired tf frame target.
